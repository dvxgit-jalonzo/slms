...
{{--                                <td>Delete</td>--}}
                            ...
                            @foreach($ticket_templates as $ticket_template)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('super-admin-ticket-template.edit', [$ticket_template->id])}}">Click to view</a>
                                    </td>
...
{{--                                    <td>--}}
{{--                                        <a href="{{ route('super-admin-ticket.destroy', [$ticket->id]) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Delete</a></td>--}}
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
