        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('administrator-user.index')}}">View User</a></li>
                </ol>
            </nav>
        </div>
    @endsection
...
{{--                                    administrator - all access with additional accesses to extra dev tools in the system.--}}
