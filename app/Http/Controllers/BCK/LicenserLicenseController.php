...
class LicenserLicenseController extends Controller
{
    ...
    public function create(){
        ...
        return view('licenser.license.create', compact('serial', 'clients', 'softwares'));
    }
...
//        ];
        ...
        return redirect()->route('licenser-license.index');
    }
