<x-master>
    ...
    @section('content')
        <section class="section dashboard">
            <form action="{{route('administrator-license.store')}}" method="POST">
                @csrf
                <div class="row">
    ...
    @section('script')
            <script>
                ...
                function readFileContent() {
                    ...
                    if (fileInput.files && fileInput.files[0]) {
                        ...
                        reader.onload = function (e) {
                            ...
                            const decryptUrl = "{{route('administrator-decrypt.content')}}";
                ...
                $("#software_id").on("change", function () {
                    ...
                    var url = "{{ route('administrator-software.get-template', ['id' => ':id']) }}";
                    ...
                    $.ajax({
                        url: "{{route('administrator-check-exist.license')}}",
                        type: 'GET',
                        data: {
