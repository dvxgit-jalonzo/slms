...
{{--                    <li class="breadcrumb-item"><a href="{{route('support-report.create')}}">File a Report</a></li>--}}
{{--                    <li class="breadcrumb-item"><a href="{{route('support-license.create')}}">Generate License</a></li>--}}
                </ol>
            </nav>
        </div>
    @endsection
