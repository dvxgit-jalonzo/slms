        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    <form action="{{route('developer-permission.store')}}" method="POST">
                        @csrf
                        ...
                        <table class="table table-sm" id="table">
                            ...
                            @foreach($permissions as $permission)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('developer-permission.edit', [$permission->id])}}" class="btn btn-sm btn-outline-dark">Edit</a></td>
                                    <td><a href="{{ route('developer-permission.destroy', [$permission->id]) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Delete</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
