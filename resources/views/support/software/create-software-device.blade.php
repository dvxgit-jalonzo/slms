<x-master>
                ...
                <div class="col-lg-6 col-12">
                    <div class="card">
                        <div class="card-body pt-3">
                            <form action="{{route('master-software.store-software-device', [$software->id])}}" method="POST">
                                @csrf
                                <div class="row" >
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 mb-3 ">
                                        <div class="float-end">
                                            ...
                                            <button class="btn btn-outline-primary">Add Software Device</button>
    ...
    @section('script')
        <script>
            ...
            <x-form-floating name="description[]" type="text" placeholder="Description" value="{{old('value')}}">
