...
class AdministratorSoftwareController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('administrator-software.index');
    }
    ...
    public function editSoftwareTemplate(string $id){
        ...
        return view('administrator.software.edit-software-template', compact('template'));
    }
