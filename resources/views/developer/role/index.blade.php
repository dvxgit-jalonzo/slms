        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    <form action="{{route('developer-role.store')}}" method="POST">
                        @csrf
                        ...
                        <table class="table table-sm" id="table">
                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('developer-role.edit', [$role->id])}}" class="btn btn-sm btn-outline-dark">Edit</a></td>
                                    <td><a href="{{ route('developer-role.destroy', [$role->id]) }}" class="btn btn-danger btn-sm" data-confirm-delete="true">Delete</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
