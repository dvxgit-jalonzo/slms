        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('super-admin-permission.index')}}">View Permissions</a></li>
                </ol>
            </nav>
        </div>
    @endsection
                ...
                <div class="col-lg-4 col-12">
                    <div class="card">
                        <div class="card-body pt-3">
                            <form action="{{route('super-admin-permission.update' , [$permission->id])}}" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="row">
