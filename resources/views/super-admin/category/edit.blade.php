        ...
        <div class="pagetitle">
            ...
            <nav>
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('super-admin-category.index')}}">View category</a></li>
                </ol>
            </nav>
        </div>
    @endsection
                ...
                <div class="col-lg-4 col-12">
                    <div class="card">
                        <div class="card-body pt-3">
                            <form action="{{route('super-admin-category.update', [$category->id])}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
