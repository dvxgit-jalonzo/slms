<x-master>
    ...
    @section('content')
        <section class="section dashboard">
            <form action="{{route('licenser-license.store')}}" method="POST">
                @csrf
                <div class="row">
    ...
    @section('script')
            <script>
                ...
                function readFileContent() {
                    ...
                    if (fileInput.files && fileInput.files[0]) {
                        ...
                        reader.onload = function (e) {
                            ...
                            const decryptUrl = "{{route('licenser-decrypt.content')}}";
                ...
                $("#software_id").on("change", function () {
                    ...
                    var url = "{{ route('licenser-software.get-template', ['id' => ':id']) }}";
                    ...
                    $.ajax({
                        url: "{{route('licenser-check-exist.license')}}",
                        type: 'GET',
                        data: {
